    ...
    return _.chain(methods)
        .map(function (method) {
            ...
            if (_.has(method, ['body', 'application/json', 'schema'])) {
                var schema = transform(JSON.parse(method.body['application/json'].schema))
                body = {
                    body: {
                        'application/json': {
                            payload: schema,
                ...
                if (_.has(method, ['body', 'application/json', 'example'])) {
                    body.body['application/json'].example = method.body['application/json'].example
                }
            }
