...
module.exports = function (options) {
    var topics = _.chain(options.schema.documentation.concat(options.additionalDocumentation))
        .filter(function (doc) {
        ...
        .map(function (doc) {
            ...
            return {
                ...
                slug: ['topic', doc.title.replace(/ /g, SLUG_SEPARATOR)].join(SLUG_SEPARATOR).toLowerCase(),
            }
        })
        .value()
