...
function getMethods (relativeUri, relativeUriPathSegments, resource) {
    ...
    return _.chain(methods)
        .map(function (method) {
            ...
            var queryParameters = _.map(jsonMethod.queryParameters, function (queryParameter) {
                if (_.isNil(queryParameter.displayName)) {
                    queryParameter.displayName = queryParameter.name
                }
            ...
            var transformedMethod = _.chain(jsonMethod)
                ...
                .extend(!_.isEmpty(queryParameters) ? {
