...
module.exports = React.createClass({
    ...
    propTypes: {
        metadata: React.PropTypes.objectOf(React.PropTypes.oneOfType([
    ...
    render: function () {
        ...
        return (
            <ul className="metadata">
                {_.map(this.props.metadata, function (value, label) {
                    return (
                        <li
                            key={label}
                        ...
                        >
                            ...
                            <div className="metadata-value">{this.renderValues(value)}</div>
                        </li>
                    )
                }.bind(this))}
            </ul>
            ...
            return (
                <ul>
                    {_.map(values, function (value, index) {
                        return <li key={index}>{this.renderValue(value)}</li>
                    }.bind(this))}
                </ul>
            )
        } else {
