...
commander
    ...
    .option('-o, --output [format]', 'A list of output formats. Must be `json`, `raml`, or `web`. Defaults [`json`].', collect, [])
    ...
    .option('-t, --tmp-dir [dir]', 'Pass a temp directory for file manipulation. Defaults to `./tmp/`.')
