...
module.exports = function (options) {
    ...
    return BPromise.resolve()
        ...
        .then(function () {
            return raml.loadApiSync(options.source).expand()
        })
...
function filterRamlOutput (filter, obj) {
    ...
    obj.resources = function () {
        return _.chain(resources)
            .map(function (resource) {
                var description = _.isNull(resource.description()) ? null : resource.description().value()
                var isMatch = !_.isEmpty(description) && description.match(filterRegex)
                if (!isMatch) return undefined
                resource.description = function () {
                    return {
                        value: function () {
                            return description.replace(filterRegex, '')
                        },
                    }
                }
                return resource
